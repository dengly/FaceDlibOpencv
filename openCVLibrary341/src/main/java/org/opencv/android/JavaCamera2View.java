    ...
    private class JavaCamera2Frame implements CvCameraViewFrame {
        ...
        public Mat bgr() {
            if (mPreviewFormat == ImageFormat.NV21)
                ...
                assert (mUVFrameData != null);
                Imgproc.cvtColorTwoPlane(mYuvFrameData, mUVFrameData, mBgr, Imgproc.COLOR_YUV2BGR_NV21);
            } else
                throw new IllegalArgumentException("Preview Format can be NV21 or YV12");
        ...
        public Mat rgb() {
            if (mPreviewFormat == ImageFormat.NV21)
                ...
                assert (mUVFrameData != null);
                Imgproc.cvtColorTwoPlane(mYuvFrameData, mUVFrameData, mRgb, Imgproc.COLOR_YUV2RGB_NV21);
            } else
                throw new IllegalArgumentException("Preview Format can be NV21 or YV12");
